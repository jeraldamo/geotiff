...
impl GeoKeyDirectory {
    pub fn new(key_directory_version: u16,
               key_revision: u16,
               minor_revision: u16,
               number_of_keys: u16) -> Self {
        Self {
    ...
    pub fn add_key(&mut self, key: GeoKeyEntry) {
        self.keys.push(key);
    }
}
...
pub struct GeoKeyEntry {
    key: TIFFKey,
    tiff_tag: Option<TIFFTag>,
    count: u16,
    value_offset: GeoKeyValueOffset,
}

impl GeoKeyEntry {
    pub fn new(key_value: u16, 
               tag_value: u16, 
               count: u16, 
               value_offset_value: u16) -> Self {

        let key = TIFFKey::from_u16(key_value).expect("Parsing non-existent TIFFKey");
        let mut tiff_tag = TIFFTag::from_u16(tag_value);
        let mut value_offset = GeoKeyValueOffset::offset(value_offset_value);

        if tag_value == 0 {
            tiff_tag = None;
            value_offset = match key {
                TIFFKey::GTModelTypeGeoKey => GeoKeyValueOffset::model_type_value(
                    TIFFKeyCodeModelType::from_u16(value_offset_value).unwrap()),

                TIFFKey::GTRasterTypeGeoKey => GeoKeyValueOffset::raster_type_value(
                    TIFFKeyCodeRasterType::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeogLinearUnitsGeoKey => GeoKeyValueOffset::linear_units_value(
                    TIFFKeyCodeLinearUnits::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeogAngularUnitsGeoKey => GeoKeyValueOffset::angular_units_value(
                    TIFFKeyCodeAngularUnits::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeographicTypeGeoKey => GeoKeyValueOffset::geographic_cs_value(
                    TIFFKeyCodeGeographicCS::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeogGeodeticDatumGeoKey => GeoKeyValueOffset::geodetic_datum_value(
                    TIFFKeyCodeGeodeticDatum::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeogEllipsoidGeoKey => GeoKeyValueOffset::ellipsoid_value(
                    TIFFKeyCodeEllipsoid::from_u16(value_offset_value).unwrap()),

                TIFFKey::GeogPrimeMeridianGeoKey => GeoKeyValueOffset::prime_meridian_value(
                    TIFFKeyCodePrimeMeridian::from_u16(value_offset_value).unwrap()),

                TIFFKey::ProjectedCSTypeGeoKey => GeoKeyValueOffset::projected_cs_value(
                    TIFFKeyCodeProjectedCS::from_u16(value_offset_value).unwrap()),

                TIFFKey::ProjectionGeoKey => GeoKeyValueOffset::projection_value(
                    TIFFKeyCodeProjection::from_u16(value_offset_value).unwrap()),

                TIFFKey::ProjCoordTransGeoKey => GeoKeyValueOffset::coordinate_transform_value(
                    TIFFKeyCodeCoordinateTransform::from_u16(value_offset_value).unwrap()),

                TIFFKey::VerticalCSTypeGeoKey => GeoKeyValueOffset::vertical_cs_value(
                    TIFFKeyCodeVerticalCS::from_u16(value_offset_value).unwrap()),

                _ => GeoKeyValueOffset::raw_value(value_offset_value),
            };
        }
...
#[derive(Debug, Copy, Clone, PartialEq)]
pub enum GeoKeyValueOffset {
    offset(u16),
    raw_value(u16),
    model_type_value(TIFFKeyCodeModelType),
    raster_type_value(TIFFKeyCodeRasterType),
    linear_units_value(TIFFKeyCodeLinearUnits),
    angular_units_value(TIFFKeyCodeAngularUnits),
    geographic_cs_value(TIFFKeyCodeGeographicCS),
    geodetic_datum_value(TIFFKeyCodeGeodeticDatum),
    ellipsoid_value(TIFFKeyCodeEllipsoid),
    prime_meridian_value(TIFFKeyCodePrimeMeridian),
    projected_cs_value(TIFFKeyCodeProjectedCS),

    projection_value(TIFFKeyCodeProjection),
    coordinate_transform_value(TIFFKeyCodeCoordinateTransform),
    vertical_cs_value(TIFFKeyCodeVerticalCS),

}


//
// Enums containing key definitions
// Obtained from <geotiff.maptools.org/spec/geotiff6.html>
//
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeRasterType {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeLinearUnits {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeAngularUnits {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeGeographicCS {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeGeodeticDatum {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodePrimeMeridian {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeProjectedCS {
        ...
        // PCS_NAD27_Indiana_West =	26774,  // TODO: Figure out how to handle these collisions
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeProjection {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeCoordinateTransform {
...
enum_from_primitive! {
    #[repr(u16)]
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
   pub enum TIFFKeyCodeVerticalCS {
